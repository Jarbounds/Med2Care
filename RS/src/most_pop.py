...
def set_recommendations_by_user(df_test, n_most_pop):
    with open('/data/SciReC2021/comm_subset_cord-19_dataset_total_ordered_filtered_groundtruth_validation_pop_rec.csv', mode='w') as file:
...
def main():
    df_train_path = '/data/SciReC2021/comm_subset_cord-19_dataset_total_ordered_filtered_train.csv'
    df_test_path = '/data/SciReC2021/comm_subset_cord-19_dataset_total_ordered_filtered_groundtruth_validation.csv'
