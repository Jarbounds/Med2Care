...
def fast_rel(all_ancestors, df_entry_ancestors, df_entry_ic, it1, it2):
    """
     Calculates the SCHLICKER MICA INTRINSIC similarity between it1 and it2
    :param all_ancestors: pandas DataFrame of all ancestors (from table transitive)
    :param df_entry_ancestors: pandas DataFrame of all ancestors (from table entry) with column IC
    :param df_entry_ic: pandas DataFrame of all entities (from table entry) with column IC
    :param it1: entity 1 (id)
    :param it2: entity 2 (id)
    :return: list: [e1, e2, sim_rel]
    """

    if it1 == it2:

        sim_rel = 1 - 10**(-df_entry_ic[df_entry_ic.id == it1].IC.to_list()[0])
...
def fast_islch(all_ancestors, df_entry_ancestors, df_entry_ic, it1, it2):
    """
    Calculates the SÁNCHEZ and BATET MICA INTRINSIC similarity between it1 and it2
    :param all_ancestors: pandas DataFrame of all ancestors (from table transitive)
    :param df_entry_ancestors: pandas DataFrame of all ancestors (from table entry) with column IC
    :param df_entry_ic: pandas DataFrame of all entities (from table entry) with column IC
    :param it1: entity 1 (id)
...
def fast_jac(all_ancestors, df_entry_ancestors, df_entry_ic, it1, it2):
    """
     Calculates the JACCARD MICA INTRINSIC similarity between it1 and it2
    :param all_ancestors: pandas DataFrame of all ancestors (from table transitive)
    :param df_entry_ancestors: pandas DataFrame of all ancestors (from table entry) with column IC
    :param df_entry_ic: pandas DataFrame of all entities (from table entry) with column IC
    :param it1: entity 1 (id)
...
def fast_resn_lin_jc(all_ancestors, df_entry_ancestors, df_entry_ic, it1, it2):
    ...
    :param it1: entity 1 (id)
    :param it2: entity 2 (id)
    :return: list: [e1, e2, sim_resnik, sim_lin, sim_jc, sim_rel]
    """
...
def fast_rel_jac_islch(all_ancestors, df_entry_ancestors, df_entry_ic, it1, it2):
    """
     Calculates the SCHLICKER, SÁNCHEZ and BATET MICA INTRINSIC similarity between it1 and it2
    :param all_ancestors: pandas DataFrame of all ancestors (from table transitive)
    :param df_entry_ancestors: pandas DataFrame of all ancestors (from table entry) with column IC
    :param df_entry_ic: pandas DataFrame of all entities (from table entry) with column IC
    :param it1: entity 1 (id)
